...
class MainWindow(wx.Frame):
    def __init__(self):
        super().__init__(None, title="Салам", size=(1000, 800))
        self.initializeUI()
    ...
    def setUpMainWindow(self, panel, sizer):
        ...
        # Текст приветствия
        hello_label = wx.StaticText(panel, label="САО БРАТИК!")
        ...
        # Изображение
        image_path = r"C:\Users\timachk\Desktop\hi.jpg"
...
class ProfileWindow(wx.Frame):
    ...
    def setUpMainWindow(self, panel, sizer):
        ...
        # Имя пользователя
        user_label = wx.StaticText(panel, label="Киреева Елизваета (рулет)")
        ...
        languages_label = wx.StaticText(panel, label="Python | просмотр анимешек")
        ...
        developer_label = wx.StaticText(panel, label="Тренер по бравл старс")
        sizer.Add(developer_label, 0, wx.LEFT | wx.TOP, 5)

        dev_dates_label = wx.StaticText(panel, label="Сентрябрь 2020 - Май 2023")
